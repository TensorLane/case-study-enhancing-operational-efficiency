...
docker tag mlops:latest 955028845085.dkr.ecr.us-east-1.amazonaws.com/mlops:latest

# push the image to ECR
docker push 955028845085.dkr.ecr.us-east-1.amazonaws.com/mlops:latest